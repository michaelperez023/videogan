...
ucf_data_dir = "/blue/ctolerfranklin/michaelperez012/videogan-pytorch/UCF-101-binary"
ucf_label_dir = "/blue/ctolerfranklin/michaelperez012/videogan-pytorch/ucfTrainTestlist-binary"
frames_per_clip = 32
...
def main():
    if not os.path.exists("./checkpoints-ft-bin"):
        os.makedirs("./checkpoints-ft-bin")
    ...
    D.conv5 = nn.Conv3d(512, 2, [2,4,4], [1,1,1]).cuda() #change last layer of D to have 2 nodes instead of one, to classify YoYo vs Kayaking videos
    ...
    result = D(vids).reshape([10, 2]) # reshape: [10, 2, 1, 1, 1] to [10, 2]
    ...
    torch.save({'epoch': epoch,
                ...
                f'checkpoints-ft-bin/finetune_state_normal{epoch}.ckpt')
