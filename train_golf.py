...
parser.add_argument(
    ...
    type=str, default="2022-04-23-20-50-41_8_30187"
)
parser.add_argument(
...
def main():
    ...
    for epoch in range(9, 10):
        ...
        if (epoch+1) % args.s == 0:
            ...
            #torch.save({'epoch': epoch, 'model_state_dict': [G.state_dict(), D.state_dict()], 'optimizer_state_dict': [optimizer_G.state_dict(), optimizer_D.state_dict()]}, f'checkpoints2/{}_{}_{}_state_normal.format(curr_time, epoch, counter)')
            torch.save({'epoch': epoch,
                                'model_state_dict': [G.state_dict(), D.state_dict()],
                                'optimizer_state_dict': [optimizer_G.state_dict(), optimizer_D.state_dict()]},
                            "./checkpoints/{}_{}_{}_state_normal.ckpt".format(curr_time, epoch, counter))
